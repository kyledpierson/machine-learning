...
if __name__ == '__main__':
    ...
    max_weights = train(train_data, train_labels, weights, update_weights, max_param, update_params, epochs=100)
    ...
    write_predictions('svm', predictor, n_features, neg_labels=True, bias=True, preprocessor=preprocessor)
